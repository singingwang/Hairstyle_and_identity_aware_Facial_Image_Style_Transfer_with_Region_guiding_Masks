...
if __name__ == '__main__':
    # 利用原始Dataset(CeleAMask-HO)，製作 Coarse Mask 和 Key Mask，存成jpg檔
    save_mask(load_dir="/home/0856609/stargan-v2-master/CelebAMask-HQ/CelebAMask-HQ-mask-anno", mapping_dir="/home/0856609/stargan-v2-master/CelebAMask-HQ/CelebA-HQ-to-CelebA-mapping.txt")
    # 將 Coarse Mask 和 Key Mask 的jpg檔轉為npy檔
    save_masks_to_npy(id_dir="jpeg/id-mask-HQ", cs_dir="jpeg/cs-mask-HQ", save_dir="npy256/mask", resolution=256)
    
    # Testing set 的女性jpg檔 (1000張) 轉成npy檔
    #save_npy(load_dir="D:/CelebA-HQ/val/female", save_dir="npy256/val/female", resolution=256)
    # Testing set 的男性jpg檔 (1000張) 轉成npy檔
    #save_npy(load_dir="D:/CelebA-HQ/val/male", save_dir="npy256/val/male", resolution=256)
    # Training set 的女性jpg檔 (17943張) 轉成npy檔
    #save_npy(load_dir="D:/CelebA-HQ/train/female", save_dir="npy256/train/female", resolution=256)
    # Training set 的男性jpg檔 (10057張) 轉成npy檔
    #save_npy(load_dir="D:/CelebA-HQ/train/male", save_dir="npy256/train/male", resolution=256)
    pass
